...
let collection = `BALANCEdataSSM`;


router.post('/08SARBALANCESSM/GENREQ', async (req, res) => {
  //-------------------------------------
  console.log("--08SARBALANCESSM/GENREQ--");
  ...
  if (input['ReqNo'] != undefined && input['InstrumentName'] != undefined && input['ReqNo'] != ''&& input['INSNO'] != '') {
    ...
    if (check1.length === 0 && check2.length === 0) {
      ...
      neworder['LIMTYPE'] = '08SARBALANCESSM';
...
router.post('/08SARBALANCESSM/UPDATEDATAWEIGHT', async (req, res) => {
  //-------------------------------------
  console.log("--08SARBALANCESSM/UPDATEDATAWEIGHT--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/08SARBALANCESSM/UPDATEDATAVOLUME', async (req, res) => {
  //-------------------------------------
  console.log("--08SARBALANCESSM/UPDATEDATAVOLUME--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/08SARBALANCESSM/UPDATEDATAAREA', async (req, res) => {
  //-------------------------------------
  console.log("--08SARBALANCESSM/UPDATEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/08SARBALANCESSM/DELETEDATAW11', async (req, res) => {
  //-------------------------------------
  console.log("--08SARBALANCESSM/DELETEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
