...
let collection = `ICS2100dataSTD`;


router.post('/54SARICS2100STD/GENREQ', async (req, res) => {
  //-------------------------------------
  console.log("--54SARICS2100STD/GENREQ--");
  ...
  if (input['ReqNo'] != undefined && input['InstrumentName'] != undefined && input['ReqNo'] != ''&& input['INSNO'] != '') {
    ...
    if (check1.length === 0 && check2.length === 0) {
      ...
      neworder['LIMTYPE'] = '54SARICS2100STD';
...
router.post('/54SARICS2100STD/UPDATEDATAPPM', async (req, res) => {
  //-------------------------------------
  console.log("--54SARICS2100STD/UPDATEDATAPPM--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/54SARICS2100STD/UPDATEDATAVOLUME', async (req, res) => {
  //-------------------------------------
  console.log("--54SARICS2100STD/UPDATEDATAVOLUME--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/54SARICS2100STD/UPDATEDATAAREA', async (req, res) => {
  //-------------------------------------
  console.log("--54SARICS2100STD/UPDATEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/54SARICS2100STD/DELETEDATAW11', async (req, res) => {
  //-------------------------------------
  console.log("--54SARICS2100STD/DELETEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
