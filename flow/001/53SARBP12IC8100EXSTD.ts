...
let collection = `ICS8100dataSTD`;


router.post('/53SARIC8100EXSTD/GENREQ', async (req, res) => {
  //-------------------------------------
  console.log("--53SARIC8100EXSTD/GENREQ--");
  ...
  if (input['ReqNo'] != undefined && input['InstrumentName'] != undefined && input['ReqNo'] != ''&& input['INSNO'] != '') {
    ...
    if (check1.length === 0 && check2.length === 0) {
      ...
      neworder['LIMTYPE'] = '53SARIC8100EXSTD';
...
router.post('/53SARIC8100EXSTD/UPDATEDATAPPM', async (req, res) => {
  //-------------------------------------
  console.log("--53SARIC8100EXSTD/UPDATEDATAPPM--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
  if (input['ReqNo'] != undefined && input['DataPreview11'] != undefined && input['ReqNo'] != ''&& input['WX'] != undefined && input['DataPreview12'] != undefined) {
...
router.post('/53SARIC8100EXSTD/UPDATEDATAVOLUME', async (req, res) => {
  //-------------------------------------
  console.log("--53SARIC8100EXSTD/UPDATEDATAVOLUME--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/53SARIC8100EXSTD/UPDATEDATAAREA', async (req, res) => {
  //-------------------------------------
  console.log("--53SARIC8100EXSTD/UPDATEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/53SARIC8100EXSTD/DELETEDATAW11', async (req, res) => {
  //-------------------------------------
  console.log("--53SARIC8100EXSTD/DELETEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
