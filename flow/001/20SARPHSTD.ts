...
let collection = `PHdataSTD`;


router.post('/04SARPHSTD/GENREQ', async (req, res) => {
  //-------------------------------------
  console.log("--04SARPHSTD/GENREQ--");
...
router.post('/04SARPHSTD/UPDATEDATAWEIGHT', async (req, res) => {
  //-------------------------------------
  console.log("--04SARPHSTD/UPDATEDATAWEIGHT--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/04SARPHSTD/UPDATEDATAVOLUME', async (req, res) => {
  //-------------------------------------
  console.log("--04SARPHSTD/UPDATEDATAVOLUME--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/04SARPHSTD/UPDATEDATAAREA', async (req, res) => {
  //-------------------------------------
  console.log("--04SARPHSTD/UPDATEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/04SARPHSTD/DELETEDATAW11', async (req, res) => {
  //-------------------------------------
  console.log("--04SARPHSTD/DELETEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
