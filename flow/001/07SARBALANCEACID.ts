...
let collection = `BALANCEdataACID`;


router.post('/07SARBALANCEACID/GENREQ', async (req, res) => {
  //-------------------------------------
  console.log("--07SARBALANCEACID/GENREQ--");
  ...
  if (input['ReqNo'] != undefined && input['InstrumentName'] != undefined && input['ReqNo'] != ''&& input['INSNO'] != '') {
    ...
    if (check1.length === 0 && check2.length === 0) {
      ...
      neworder['LIMTYPE'] = '07SARBALANCEACID';
...
router.post('/07SARBALANCEACID/UPDATEDATAWEIGHT', async (req, res) => {
  //-------------------------------------
  console.log("--07SARBALANCEACID/UPDATEDATAWEIGHT--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/07SARBALANCEACID/UPDATEDATAVOLUME', async (req, res) => {
  //-------------------------------------
  console.log("--07SARBALANCEACID/UPDATEDATAVOLUME--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/07SARBALANCEACID/UPDATEDATAAREA', async (req, res) => {
  //-------------------------------------
  console.log("--07SARBALANCEACID/UPDATEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/07SARBALANCEACID/DELETEDATAW11', async (req, res) => {
  //-------------------------------------
  console.log("--07SARBALANCEACID/DELETEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
