...
let collection = `XRFdataSTD`;


router.post('/51SARIC01STD/GENREQ', async (req, res) => {
  //-------------------------------------
  console.log("--51SARIC01STD/GENREQ--");
...
router.post('/51SARIC01STD/UPDATEDATAPPM', async (req, res) => {
  //-------------------------------------
  console.log("--51SARIC01STD/UPDATEDATAPPM--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/51SARIC01STD/UPDATEDATAVOLUME', async (req, res) => {
  //-------------------------------------
  console.log("--51SARIC01STD/UPDATEDATAVOLUME--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/51SARIC01STD/UPDATEDATAAREA', async (req, res) => {
  //-------------------------------------
  console.log("--51SARIC01STD/UPDATEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/51SARIC01STD/DELETEDATAW11', async (req, res) => {
  //-------------------------------------
  console.log("--51SARIC01STD/DELETEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
