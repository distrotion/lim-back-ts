...
let collection = `UVdataSTD`;


router.post('/41SARUVSTD/GENREQ', async (req, res) => {
  //-------------------------------------
  console.log("--41SARUVSTD/GENREQ--");
...
router.post('/41SARUVSTD/UPDATEDATAPPM', async (req, res) => {
  //-------------------------------------
  console.log("--41SARUVSTD/UPDATEDATAPPM--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/41SARUVSTD/UPDATEDATAVOLUME', async (req, res) => {
  //-------------------------------------
  console.log("--41SARUVSTD/UPDATEDATAVOLUME--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/41SARUVSTD/UPDATEDATAAREA', async (req, res) => {
  //-------------------------------------
  console.log("--41SARUVSTD/UPDATEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/41SARUVSTD/DELETEDATAW11', async (req, res) => {
  //-------------------------------------
  console.log("--41SARUVSTD/DELETEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
