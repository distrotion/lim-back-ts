...
router.post('/40SARXRFSTD/GENREQ', async (req, res) => {
  //-------------------------------------
  console.log("--40SARXRFSTD/GENREQ--");
...
router.post('/40SARXRFSTD/UPDATEDATAPPM', async (req, res) => {
  //-------------------------------------
  console.log("--40SARXRFSTD/UPDATEDATAPPM--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/40SARXRFSTD/UPDATEDATAVOLUME', async (req, res) => {
  //-------------------------------------
  console.log("--40SARXRFSTD/UPDATEDATAVOLUME--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/40SARXRFSTD/UPDATEDATAAREA', async (req, res) => {
  //-------------------------------------
  console.log("--40SARXRFSTD/UPDATEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/40SARXRFSTD/DELETEDATAW11', async (req, res) => {
  //-------------------------------------
  console.log("--40SARXRFSTD/DELETEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
