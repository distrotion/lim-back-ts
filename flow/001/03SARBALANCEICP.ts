...
let collection = `BALANCEdataICP`;


router.post('/04SARBALANCEICP/GENREQ', async (req, res) => {
  //-------------------------------------
  console.log("--04SARBALANCEICP/GENREQ--");
  ...
  if (input['ReqNo'] != undefined && input['InstrumentName'] != undefined && input['ReqNo'] != ''&& input['INSNO'] != '') {
    ...
    if (check1.length === 0 && check2.length === 0) {
      ...
      neworder['LIMTYPE'] = '04SARBALANCEICP';
...
router.post('/04SARBALANCEICP/UPDATEDATAWEIGHT', async (req, res) => {
  //-------------------------------------
  console.log("--04SARBALANCEICP/UPDATEDATAWEIGHT--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/04SARBALANCEICP/UPDATEDATAVOLUME', async (req, res) => {
  //-------------------------------------
  console.log("--04SARBALANCEICP/UPDATEDATAVOLUME--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/04SARBALANCEICP/UPDATEDATAAREA', async (req, res) => {
  //-------------------------------------
  console.log("--04SARBALANCEICP/UPDATEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
...
router.post('/04SARBALANCEICP/DELETEDATAW11', async (req, res) => {
  //-------------------------------------
  console.log("--04SARBALANCEICP/DELETEDATAW11--");
  console.log(req.body);
  let input = req.body;
  //-------------------------------------
  let output = 'nok';
